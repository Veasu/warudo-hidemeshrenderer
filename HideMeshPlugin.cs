...
namespace veasu.hiderenderer {
  [PluginType(Id = "com.veasu.hiderendererplugin", 
  Name = "Hide Mesh Renderer Node", 
  Description = "Adds a node to hide mesh renderers from assets.", 
  Author = "Veasu", 
  Version = "0.1.0", 
  ...
  NodeTypes = new System.Type[] {typeof (HideMeshRendererNode)})]
  public class HideRendererPlugin : Plugin
  {
  }
}
